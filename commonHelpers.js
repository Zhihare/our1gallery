(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function i(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerpolicy&&(n.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?n.credentials="include":e.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(e){if(e.ep)return;e.ep=!0;const n=i(e);fetch(e.href,n)}})();(()=>{const t={openMenuBtn:document.querySelector("[data-menu-open]"),closeMenuBtn:document.querySelector("[data-menu-close]"),menu:document.querySelector("[data-menu]"),links:document.querySelectorAll(".mobile-menu-link"),header:document.querySelector("[data-menu-header]")};t.openMenuBtn.addEventListener("click",a),t.links.forEach(function(i){i.addEventListener("click",a)});function a(){t.menu.classList.toggle("is-open"),t.header.classList.toggle("is-open")}})();const l=document.querySelectorAll('a[href*="#"]');for(let t of l)t.addEventListener("click",function(a){a.preventDefault();const i=t.getAttribute("href").substr(1);document.getElementById(i).scrollIntoView({behavior:"smooth",block:"start"})});(function(t){typeof t.matches!="function"&&(t.matches=t.msMatchesSelector||t.mozMatchesSelector||t.webkitMatchesSelector||function(a){for(var i=this,o=(i.document||i.ownerDocument).querySelectorAll(a),e=0;o[e]&&o[e]!==i;)++e;return Boolean(o[e])}),typeof t.closest!="function"&&(t.closest=function(a){for(var i=this;i&&i.nodeType===1;){if(i.matches(a))return i;i=i.parentNode}return null})})(window.Element.prototype);document.addEventListener("DOMContentLoaded",function(){var t=document.querySelectorAll(".js-open-modal"),a=document.querySelector(".js-overlay-modal"),i=document.querySelectorAll(".js-modal-close");t.forEach(function(o){o.addEventListener("click",function(e){e.preventDefault();var n=this.getAttribute("data-modal"),r=document.querySelector('.modal[data-modal="'+n+'"]');r.classList.add("active"),a.classList.add("active")})}),i.forEach(function(o){o.addEventListener("click",function(e){var n=this.closest(".modal");n.classList.remove("active"),a.classList.remove("active")})}),document.body.addEventListener("keyup",function(o){var e=o.keyCode;e==27&&(document.querySelector(".modal.active").classList.remove("active"),document.querySelector(".overlay").classList.remove("active"))},!1),a.addEventListener("click",function(){document.querySelector(".modal.active").classList.remove("active"),this.classList.remove("active")})});const s=[{id:1,img:"./img/event/image 1761x.png",img2x:"./img/event/image 1762x.png",data:"May 6, 2023 - November 12, 2024",title:"Lauren Halsey",text:"The Spotlight exhibition series includes a new or never-before-exhibited artwork accompanied by a commissioned piece of writing. It is the hope of this series to create focused and thoughtful dialogues between the visual arts and critics, poets, scholars, etc.In this iteration, the Spotlight features Lauren Halsey’s portal."},{id:2,img:"./img/event/image 1761x (1).png",img2x:"./img/event/image 1762x (1).png",data:"October 6, 2023 - December 22, 2024",title:"Friends & Lovers",text:"Friends & Lovers is an expansive group exhibition that centers on the relationships between artists and their subjects and explores the infinite ways (both past and present) we are influenced by our inner circles. Highlighting a range of media, practices, and approaches to artmaking, artists in the exhibition include   Peter Cain."},{id:3,img:"./img/event/image 1771x.png",img2x:"./img/event/image 1772x.png",data:"October 6, 2023 - December 22, 2024",title:"Cynthia Daignault",text:"Cynthia Daignault’s new series of paintings—part solo exhibition, virtual group show, and curatorial project—is a collaboration with 36 artists exploring ideas of agency, appropriation, and the traces we leave behind.In collaboration with Cory Arcangel, Conor Backman, Sadie Barnette, Jason Bereswill, Todd Bienvenu, Carol Bove,   Canyon Castato."}];console.log(s);const u={eventList:document.getElementById("EventList")};u.eventList.insertAdjacentHTML("beforeend",g(s));function g(t){return t.reduce((a,{id:i,img:o,img2x:e,data:n,title:r,text:c})=>a+`
	...
	<h2 class="event-title">${r}</h2>
	<p class="event-data">${n}</p>
	...
	<div class="catalog-price-container">
		<p class="catalog-title">${n}</p>
		<p class="catalog-price">${r}</p>
	</div>
	</li>
	`,"")}const h={past:document.getElementById("pastexb")},x=[{id:1,img:"./img/Past/image 1771x.png",img2x:"./img/Past/image 1772x.png"},{id:2,img:"./img/Past/image 1791x.png",img2x:"./img/Past/image 1792x.png"},{id:3,img:"./img/Past/image 1801x.png",img2x:"./img/Past/image 1802x.png"},{id:4,img:"./img/Past/image 1811x.png",img2x:"./img/Past/image 1812x.png"}];h.past.insertAdjacentHTML("beforeend",f(x));function f(t){return t.reduce((a,{id:i,img:o,img2x:e})=>a+`
